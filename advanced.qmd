...
secondary structure state (symbol or probability) to each residue. Threading and
*ab initio* structure prediction methods implement or call third parties methods
to predict secondary structure and other 1D features, as important additional
information during modeling process.
...
+------------------+-------------------------------------+--------------------+
|                  | [GOR](h%20ttp                       | 63-73.5%\          |
|                  | s://npsa-prabi.ibcp.fr/cgi-bin/n%20 | (Version V)        |
...
|                  | NNSSP (1995)                        | 72%                |
+------------------+-------------------------------------+--------------------+
| N-N neural       | [APSSP](h%20                        | Up to 86%          |
| network          | ttp://imtech.res.in/raghava/apssp/) |                    |
+------------------+-------------------------------------+--------------------+
|                  | [PsiPRED](h%20                      | 75.7% (1999)       |
|                  | ttp://bioinf.cs.ucl.ac.uk/psipred/) |                    |
|                  | (1999-)                             | 84% (2019)         |
+------------------+-------------------------------------+--------------------+
|                  | [PHD](https:%20//n                  | 74%                |
|                  | psa-prabi.ibcp.fr/cgi-bin/npsa_a%20 |                    |
...
use of multilayer neural networks [@jones2015; @ma2015a; @wang2017a; @yang2020].
These methods implemented the use of the so-called high resolution contact maps,
which contains enriched information with not only contacts but also distances,
