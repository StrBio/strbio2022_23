...
[![Schematic workflow of X-ray
crystallography.](images/paste-F430F5B1.png){#fig-xray
...
[![Basis of nuclear magnetic resonance](images/paste-2013F0AC.png){#fig-rmn
.figure}](https://www.creative-biostructure.com/comparison-of-crystallography-nmr-and-em_6.htm)
...
[![Coverage of molecular weight by structural
technique](images/paste-FA73AF1E.png){#fig-experimental
...
[![The process of Cryo-EM single particle analysis
technique](images/paste-5E29F580.png){#fig-cryoEM
.figure}](https://www.creative-biostructure.com/comparison-of-crystallography-nmr-and-em_6.htm)
...
[![Cryo-electron microscopy revolution](images/paste-E5E5AE75.png){#fig-cryoEM2
.figure}](https://www.creative-biostructure.com/comparison-of-crystallography-nmr-and-em_6.htm)
...
modeling global parameters can be controversial, we can analyze model's
...
these kind of molecules, based in our knowledge from high-res structures. That
means that the (best) structures in the current structural space define what is
"normal" in a protein. The advantage of these analysis and derived parameters is
that they do not consider the process that lead to the model, the only consider
the final product and its reliability.

One of the most common and powerful method to asses the stereochemistry of a
...
## [1. A 10-steps self-guided practice](https://www.evernote.com/shard/s62/client/snv?noteGuid=666c39a1-ac03-64c9-b8a0-cab9ff3959c7&noteKey=9d20b6eadae8d130fdbe6652d60237f2&sn=https%3A%2F%2Fwww.evernote.com%2Fshard%2Fs62%2Fsh%2F666c39a1-ac03-64c9-b8a0-cab9ff3959c7%2F9d20b6eadae8d130fdbe6652d60237f2&title=StrBio%2B2022%252F2023%2B-%2B3.%2BPymol%2BPractice)
